...
class Export:
    def __init__(self, partner, calc_history):
        ...
        self.export_text = Label(self.export_frame, text="If the filename you enter below already exists, its contents will be replaced with you calculation history",
                            justify=LEFT, bg=background, fg="maroon",
